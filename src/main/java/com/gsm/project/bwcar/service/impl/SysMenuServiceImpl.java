...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    public R findUserMenu(Long userId) {
        //查询用户的一级目录
        List<Map<String, Object>> dirMenuByUserId = sysMenuDao.findDirMenuByUserId(userId);
        //查询目录对应的子菜单
        for (Map<String, Object> map : dirMenuByUserId) {
            Long menuId = Long.parseLong(map.get("menuId")+"");
            List<Map<String, Object>> subList = sysMenuDao.findMenuNotButtonByUserId(userId, menuId);
