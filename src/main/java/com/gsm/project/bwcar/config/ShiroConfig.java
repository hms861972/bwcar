package com.gsm.project.bwcar.config;

import com.gsm.project.bwcar.realm.UserRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean  shiroFilterFactoryBean(SecurityManager securityManager){
        ...
        shiroFilterFactoryBean.setSuccessUrl("/static/index.html");
        shiroFilterFactoryBean.setUnauthorizedUrl("unauthorized.html");
        //拦截的路径的详细设置
        //什么Map是存取有序的？
        Map<String,String> map = new LinkedHashMap<>();
        map.put("/sys/user/login","anon");//匿名访问
        map.put("/sys/user/captcha.jpg","anon");//验证码放行
        map.put("/static/public/**","anon");
        map.put("static/json/**","anon");
        map.put("/**","authc");
